...
class GRiDTorch:
    ...
    def _load_extension(self):
        ...
        try:
            ...
            # Get the directory containing grid.cuh
            grid_include_dir = os.path.dirname(os.path.abspath(__file__))
            
            self.cpp_module = load(
                name='grid_torch_cpp',
                sources=['grid_torch_ops.cpp'],
                extra_include_paths=[grid_include_dir],
